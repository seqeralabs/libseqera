...
/*
 * NOTE: this class is adapted from Gson extras module which is not included in the default
 ...
 * }</pre>
 *
 * @param <T> the base type for which this factory provides type adapters
...
public class RuntimeTypeAdapterFactory<T> implements TypeAdapterFactory {
    ...
    /**
     * Creates a new RuntimeTypeAdapterFactory.
     *
     * @param baseType the base type for polymorphic serialization
     * @param typeFieldName the JSON field name that holds the type discriminator
     * @param maintainType if true, the type field is preserved in the JSON object during deserialization
     */
     ...
     *
     * @param type the subtype class to register
     * @param label the JSON label for this subtype
     * @return this factory for method chaining
    ...
    /**
     * Gets the subtype class for a given label.
     *
     * @param label the type label
     * @return the corresponding subtype class, or null if not found
     */
    ...
    /**
     * Gets the label for a given subtype class.
     *
    ...
    /**
     * Gets the type field name used for type discrimination.
     *
