...
/**
 * Minimal pure-Java {@link AbstractMessageStream} subclass used by
 * {@code StreamMetricsClassloaderTest}.
 *
 ...
 */
public class TestPlainStream extends AbstractMessageStream<String> {
    ...
    @Override
    protected String name() { return "test-plain-stream"; }
